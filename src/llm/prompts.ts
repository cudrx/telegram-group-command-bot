...
const EXPLAIN_PROMPT = [
  ...
  "- first section: <b>Смысл</b>",
  "- optional second section: <b>По сути</b>",
  "- max 3 short bullets total",
...
const SUMMARIZE_PROMPT = [
  ...
  "- End the response after the summary bullets.",
  "- use only the Telegram HTML subset from the global rules",
  "- do not start every answer with the same heading",
  "- do not use a generic summary heading"
].join("\n");
