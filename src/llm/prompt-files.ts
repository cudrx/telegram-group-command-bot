...
export const PROMPT_FILE_PATHS = {
  ...
  replyContextExplain: 'llm/reply/context-explain.md',
  replyContextDescribe: 'llm/reply/context-describe.md',
  replyContextGeneric: 'llm/reply/context-generic.md',
  replyChatTranscript: 'llm/reply/chat-transcript.md',
