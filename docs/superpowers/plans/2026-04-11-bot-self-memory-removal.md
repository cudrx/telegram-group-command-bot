...
- Do not commit during implementation unless the user explicitly asks for commits; collect suggested commit groupings instead.
...
- [ ] **Step 5: Record Task 1 commit suggestion**

Do not commit unless the user explicitly asks. Record this suggested commit grouping for later:
...
Expected: no command is run yet; this is only a suggested future commit.
...
- [ ] **Step 6: Record Task 2 commit suggestion**
...
- [ ] **Step 10: Record Task 3 commit suggestion**
...
- [ ] **Step 7: Record Task 4 commit suggestion**
...
- [ ] **Step 3: Record Task 5 commit suggestion**
...
- [ ] **Step 5: Record any verification-only docs correction**

If the manual probe reveals only a documentation mismatch, update docs and record this suggested commit grouping for later:
...
Expected: no command is run yet; source changes are not mixed into this docs-only correction if the user later asks for commits.
